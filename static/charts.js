...
function chart3(data){
    // Set the chart dimensions 
        let margins = {top: 20, right: 20, bottom: 30, left: 40};
...
function chart4(data) {
    // define dimensions 
    let margins ={"top":30, "bottom":30,"left": 50, "right":50};
    let height = 500 - margins.top - margins.bottom;
    let width  = 500 - margins.left - margins.right;
    ...
    svg.selectAll("circle")
        ...
        .attr("cy", function(d) { return yscale(d.days); })
        .attr("r", 4);
...
function chart5(data){
    ...
    // define dimensions 
    let margins ={"top":30, "bottom":30,"left": 60, "right":50};
    let height = 500 - margins.top - margins.bottom;
    let width  = 500 - margins.left - margins.right;
